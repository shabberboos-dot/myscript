...
// @version      150.0.0
// @description  NX XHAWON | Normal: Market Follow | 3 Loss → Opposite Trade → Pattern Recovery | Double Martingale | Full Balance on Low
// @author       𝗡𝗫 𝗫𝗛𝗔𝗪𝗢𝗡
// @match        *://*/*
// @grant        none
// ==/UserScript==
...
(function(){
    ...
    loadFirebase(() => {
        ...
        // ==========================================
        // 3. CUSTOM LOGIC (Normal + Opposite Trade + Pattern Recovery)
        // ==========================================
        ...
        const UserPatternLogic = (h) => {
            ...
            if (st.isRecovery) {
                ...
                if (p1 && p2 && p1 === p2) {
                    console.log(`🔄 RECOVERY MODE (BOTH MATCH): ${p1}`);
                    return p1;
                } else {

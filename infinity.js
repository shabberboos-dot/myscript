...
(function(){
    ...
    loadFirebase(() => {
        ...
        h_ui.innerHTML = `<span class="txt-blk drx-title-anim" id="drx-title" ondblclick="window._toggleML()">${uF('𝐃𝐑𝐗-𝐓𝐌')}</span><span style="cursor:pointer;" class="txt-blk-err" id="sys-cls">X</span>`;
        ...
        window._toggleML = function() {
            ...
            if(st.mlActive) {
                titleEl.style.color = '#0ff'; titleEl.innerText = uF('𝐃𝐑𝐗-𝐓𝐌 (ML)');
            } else {
                titleEl.style.color = ''; titleEl.innerText = uF('𝐃𝐑𝐗-𝐓𝐌');
            }
        };

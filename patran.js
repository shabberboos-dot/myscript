...
(function(){
    ...
    // ==========================================
    //  . FIREBASE CONNECT & ADMIN CONTROL (NEW)
    // ==========================================
    ...
    loadFirebase(() => {
        ...
        const _cE_old = () => { // Renamed to avoid conflict
            if(Date.now() > _eT) {
        ...
        // CUSTOM PATTERN LOGIC (1ST PATTERN OF NUMBER)
        const UserPatternLogic = (h) => {
            if(!h || h.length < 2) return 'BIG'; 
            ...
            switch(first){
                case 1: signal = 'BIG'; break;
                case 2: signal = 'SMALL'; break;
                case 3: signal = 'BIG'; break;
                case 4: signal = 'BIG'; break;
                case 5: signal = 'SMALL'; break;
                case 6: signal = 'BIG'; break;
                case 7: signal = 'SMALL'; break;
                case 8: signal = 'SMALL'; break;
                case 9: signal = 'SMALL'; break;
                case 0:
        ...
        goBtn.onclick = () => {
            //  Admin Check Added in start button
            if (window._checkAdminStatus()) return;
